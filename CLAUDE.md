...
Test baseline: **148 suites / 2150 tests PASS**, tsc 0 errors. (Updated 2026-06-13; canonical number maintained in `docs/internal/CONTEXT.md` → «Гейты».) Any deviation must be acknowledged before merge.
