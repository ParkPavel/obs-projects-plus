...
Test baseline: **158 suites / 2260 tests PASS**, tsc 0 errors. (Updated 2026-06-20 #094; canonical number maintained in `docs/internal/CONTEXT.md` → «Гейты».) Any deviation must be acknowledged before merge.
