...
export const WIDGET_TEMPLATES: WidgetTemplate[] = [
  {
    ...
    labelKey: "views.database.templates.overview-finance",
    description: "Quick finance overview with KPI, summary, chart and table",
    descriptionKey: "views.database.templates.overview-finance-desc",
    widgets: [
      {
        id: wid(),
        type: "stats",
  ...
  // weight progression and count total volume across workouts.
  {
    ...
    labelKey: "views.database.templates.fitness-workout",
    description: "Workout notes with nested sets[]: reps, weight, rest. Uses Unnest pipeline + volume stats.",
    descriptionKey: "views.database.templates.fitness-workout-desc",
    isVertical: true,
    icon: "🏋️",
    widgets: [
      {
  ...
  // ── Vertical: Finance / Accounting — tax, rate, credit line ────────────
  {
    ...
    labelKey: "views.database.templates.finance-accounting",
    description: "Multi-currency dashboard: gross, tax, net with FX rates and credit line tracking.",
    descriptionKey: "views.database.templates.finance-accounting-desc",
    isVertical: true,
    icon: "💰",
    widgets: [
      {
  ...
  // ── Vertical: CRM / Clients — sessions history ─────────────────────────
  {
    id: "crm-clients",
    label: "CRM — Clients",
    labelKey: "views.database.templates.crm-clients",
    description: "Clients roster with session history, filter tabs by stage, and conversion funnel.",
    descriptionKey: "views.database.templates.crm-clients-desc",
    isVertical: true,
    icon: "👥",
    widgets: [
      {
