<script lang="ts">
  ...
  const presetViews = [
    { id: "table", labelKey: "views.dashboard.viewport.table" },
    { id: "board", labelKey: "views.dashboard.viewport.board" },
    { id: "calendar", labelKey: "views.dashboard.viewport.calendar" },
    { id: "gallery", labelKey: "views.dashboard.viewport.gallery" },
  ];
</script>

<div class="ppp-viewport-selector">
  <div class="ppp-viewport-selector-title">{$i18n.t("views.dashboard.viewport.embed")}</div>
