 ...
 */
export const toolbarCollapsed = createPersistentStore<boolean>(
  "toolbarCollapsed",
  false
);
...
export const needsMobileUI = derived(isMobile, ($isMobile) => $isMobile);
...
export const currentBreakpoint = derived(windowSize, ($size) => {
...
export const orientation = derived(windowSize, ($size) =>
  $size.width > $size.height ? "landscape" : "portrait"
);

/** Текущая ширина окна */
export const viewportWidth = derived(windowSize, ($size) => $size.width);

/** Текущая высота окна */
export const viewportHeight = derived(windowSize, ($size) => $size.height);
