...
describe("emptiness — kernel", () => {
  ...
  describe("isNullish", () => {
    ...
    test("empty string is NOT nullish", () =>
  ...
  describe("isEmpty", () => {
    ...
    test("whitespace-only string is NOT empty", () =>
    ...
    test("Date instance is NOT empty", () =>
  ...
  // ── isNotEmpty ───────────────────────────────────────
  describe("isNotEmpty", () => {
    test("inverse of isEmpty for null", () =>
      expect(isNotEmpty(null)).toBe(false));
    test("inverse of isEmpty for empty string", () =>
      expect(isNotEmpty("")).toBe(false));
    test("inverse of isEmpty for non-empty array", () =>
