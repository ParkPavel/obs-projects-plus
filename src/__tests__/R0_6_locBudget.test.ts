...
const BUDGETS: ReadonlyArray<{ file: string; maxLines: number }> = [
  ...
  {
    file: "ui/views/Dashboard/widgets/WidgetHeaderActions.svelte",
    maxLines: 220,
  },
  ...
  {
    file: "ui/views/Dashboard/widgets/widgetComponentRegistry.ts",
    maxLines: 260,
  },
  ...
  {
    file: "ui/views/Dashboard/widgets/WidgetPrimaryAction.svelte",
    maxLines: 90,
  },
  ...
  // 200 → 190 (#191): the templates controller, its confirm dialog mount and
  // the apply-template handler left the canvas. Banked to the MEASURED size in
  // the same commit as the removal, not to a round number — the 240 → 230
  // precedent from #184, and the rule this ratchet exists to enforce.
  { file: "ui/views/Dashboard/DashboardCanvas.svelte", maxLines: 190 },
  { file: "ui/views/Dashboard/dashboardSuggest.ts", maxLines: 60 },
  // F2 (#074) — TABLE_V2_CANON §5 budgets
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/DataTableContent.svelte",
    maxLines: 280,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/TableControlBar.svelte",
    maxLines: 200,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/TableHeader.svelte",
    maxLines: 200,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/TableRow.svelte",
    maxLines: 200,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/TableFooter.svelte",
    maxLines: 120,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/tableCanon.ts",
    maxLines: 260,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/EditableCell.svelte",
    maxLines: 250,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/CellChoiceDropdown.svelte",
    maxLines: 130,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/TableNewRow.svelte",
    maxLines: 100,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/tableRowOps.ts",
    maxLines: 170,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/tableHeaderOps.ts",
    maxLines: 230,
  },
  { file: "ui/views/Dashboard/widgets/ViewTabBar.svelte", maxLines: 260 },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/TableGroupSection.svelte",
    maxLines: 100,
  },
  {
    file: "ui/views/Dashboard/widgets/DatabaseCall/RelationPickerPopover.svelte",
    maxLines: 240,
  },
];
...
describe("R0.6 component LOC budgets (#067)", () => {
  it.each(BUDGETS)(
    "$file stays within $maxLines lines",
    ({ file, maxLines }) => {
