 ...
 */
// /skip @typescript-eslint/no-explicit-any - Plugin.loadData() returns unknown, accepts any settings version
...
// /skip @typescript-eslint/no-explicit-any - V1 data source config varies by kind
