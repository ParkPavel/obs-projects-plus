...
## Текущий релиз: v3.2.1

**Дата релиза**: 9 апреля 2026  
**Статус**: 🟢 Стабильный  
**Совместимость**: Obsidian 1.5.7+
**Тип**: Bugfix & Mobile UX — фикс попаверов, переписана тач-архитектура ViewSwitcher, исправлен выбор даты в Agenda, устранена уязвимость CSS-пайплайна
