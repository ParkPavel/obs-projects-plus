...
| [Демо-хранилище](demo-vault/README-RU.md) | Готовые данные, чтобы попробовать без своих заметок |
| [Шаблоны заметок](templates/README.md) | Шаблоны Templater и стандартные поля |
| [Устройство кода](docs/architecture.md) | Слои, правила зависимостей, куда добавлять новое |
| [Как участвовать](CONTRIBUTING-RU.md) | Как собрать, проверить и предложить изменение |
| [API своих представлений](docs/api-RU.md) | Своё представление из другого плагина |
| [Изменения](CHANGELOG-RU.md) | Что изменилось и на что смотреть при обновлении |

Каждый документ есть и по-английски: файл с суффиксом `-EN` рядом с русским.
