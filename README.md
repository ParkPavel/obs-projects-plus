...
Projects Plus поддерживает интеграцию с плагином [Templater](https://github.com/SilentVoid13/Templater) для автоматизации создания заметок.

### Быстрая настройка

1. **Установите Templater** из Community Plugins
2. **Скачайте шаблон** [Projects Plus Template.md](templates/Projects%20Plus%20Template.md)
3. **Поместите в папку шаблонов** вашего хранилища
4. **Настройте в Projects Plus**:
...
При создании новой заметки шаблон последовательно запросит:

| Шаг | Поле | Описание |
|-----|------|----------|
| 1 | **Название** | Заголовок заметки |
| 2 | **Тип** | Событие / Задача / Встреча / Проект / Заметка |
| 3 | **Дата** | Основная дата (YYYY-MM-DD) |
| 4 | **Время** | Начало и окончание (опционально) |
| 5 | **Продолжительность** | Один или несколько дней |
| 6 | **Статус** | Inbox / Scheduled / In Progress / Done |
| 7 | **Цвет** | Цвет события в календаре |

### Поля frontmatter

Шаблон автоматически заполняет поля, совместимые со всеми представлениями:
...
> **Совет**: Настройте горячую клавишу `Alt+N` для быстрого создания заметок через Templater.
