...
- [ ] Calendar DnD: drag event to another day/time (Week/Day view)
- [ ] Calendar DnD: resize multi-day event strip
- [ ] Board DnD: drag card via grip handle
- [ ] Mobile DnD: long-press + drag on touch device
