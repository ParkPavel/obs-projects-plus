...
другие представления. Выберите руководство по своей задаче.

Projects Plus displays Obsidian Markdown notes as tables, boards, calendars and other
views. Choose the guide that matches your task.

| Задача / Task | Русский | English |
|---|---|---|
| Установить и начать / Install and start | [Обзор](../README.md) | [Overview](../README-EN.md) |
| Настроить проект и работать с заметками / Work with projects and notes | [Руководство](user-guide.md) | [User guide](user-guide-EN.md) |
| Разработать своё представление / Develop a custom view | [API](api-ru.md) | [API](api.md) |
| Понять сообщение об ошибке / Understand an error | [Коды ошибок](ERROR_CODES.md) | [Error codes](ERROR_CODES.md) |

## Примеры / Examples

- [Шаблоны заметок / Note templates](../templates/README.md)
- [Демонстрационное хранилище / Demo vault](../demo-vault/README.md)
