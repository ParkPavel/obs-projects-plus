...
**Решение**: Оставить `@ts-ignore` с комментариями. Immer проверен в бою; корректность во время выполнения подтверждена 839 модульными тестами.
...
- [ ] `npm test` — Все 839 тестов проходят
