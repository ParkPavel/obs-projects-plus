...
- **Canonical baseline — `main`: 204 suites / 3282 tests PASS, tsc 0, svelte-check 0/0,
  lint 0 errors (109 pre-existing tsdoc warnings).** Measured 2026-09-04 on `main` after #184 step 1
