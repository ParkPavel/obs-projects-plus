...
- **Canonical baseline — branch `feat/116-filter-order-adr` (2026-08-25 post config-drift ratchet):
  168 suites / 2394 tests PASS, tsc 0, lint 0 (125 pre-existing tsdoc warnings),
