...
> Обновлено: **2026-06-19 (ЭПИК #090 панели виджетов §3 — slices 1–4a DONE, стек 5 коммитов на `feat/090-widget-config-anatomy`, готов к merge/push; baseline 158/2246, px-budget 177. Слайсы: 1 ChartConfig слайдеры-значения, 2 DatabaseCallSettings человеческие подписи+D1, 3 §3-секции ChartConfig, 4a i18n ChecklistConfig. Остаток slice 4b: StatsConfig (нет блока + динам. fmt-*) + FilterTabsConfig i18n. Программное тестирование зелёное (headless + API 11/11). Ранее: #093 DONE (`feat/093` смержен), #103 DONE, UT-R5 audit. Следующий шаг = #090 slice 4b → затем W2.3)**
...
| W2.2 | **#090** панели виджетов (анатомия §3) | 🔵 slices 1–4a DONE (`feat/090`); остаток slice 4b (Stats/FilterTabs i18n) |
