...
- **Canonical baseline — `main`: 201 suites / 3242 tests PASS, tsc 0, svelte-check 0/0,
  lint 0 errors (109 pre-existing tsdoc warnings).** Measured 2026-09-03 on `main` after #169
