...
| Current relation contract is only declarations. | `src/lib/relations/contracts.ts:1-83` has no implementation consumers. | Make it the owner of public types or remove its normative claim. |
