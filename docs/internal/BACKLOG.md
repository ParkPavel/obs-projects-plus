...
- Status: 📋 TODO — наблюдение 2026-09-04, карта получена | Milestone: (next) | Priority: P3 | Complexity: M
...
- **Порядок, по образцу #178/#183:** карта (есть) → проверка хранилищ на `apply-template` → удаление
  с архивом → сравнение бандла до/после → аудит. Пока проверка хранилищ не сделана, удалять нельзя.
