...
- **Дальше:** план архитектора → Gate 0 (Codex ищет, что в нём неверно) → решение пользователя о
  реализации. Ветка `fix/211-conflict-races` до этого момента остаётся вне `main`.
