...
- Status: 🔄 ЧАСТИЧНО 2026-09-03 — focus-trap и табуляция сделаны, приёмка автоматизирована
  (`A169_focusPriority.acceptance.test.ts`); визуальный вес и шкала слоёв открыты
...
- **Осталось открытым:** визуальный вес (первичное действие блока весомее cog, фильтр вида в
  постоянно видимую полосу) и одна шкала `z-index`; лишняя остановка Tab у `WidgetShell`
  (`accessibility.ts:56`) не тронута.
