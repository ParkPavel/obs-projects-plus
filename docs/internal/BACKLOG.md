...
- Status: 🔄 ЧАСТИЧНО 2026-09-03 — focus-trap, табуляция и шкала слоёв сделаны, приёмка
  автоматизирована; **открыт только визуальный вес** (нужен проход designer)
...
- **Реализация требует прохода архитектора:** три файла и изменение поведения. Это следующий шаг,
  и он не сделан.
