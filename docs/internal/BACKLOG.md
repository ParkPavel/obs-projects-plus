...
- Status: ✅ DONE для четырёх «Key files» (2026-08-31); остаток долга открыт | Milestone: (next) | Priority: P1 | Complexity: M
...
- **Остаток:** `transformTypes.ts` (16), `filterEvaluator.ts` (12), `contracts.ts` (11),
  `accessibility.ts` (7). Метрика не покрывает `.svelte` — реальная доля выше измеренной.
- analysis_required: false
...
- Status: ⚠ ЧАСТИЧНО (2026-08-31) — факты установлены, решение о схеме за пользователем | Milestone: pre-alpha | Priority: **P0** | Complexity: S
