...
- Status: 🔧 В РАБОТЕ — шаги 0–4 сделаны 2026-09-07 на `feat/200-step1-verdict`; остаётся шаг 5 (живой прогон) | Milestone: (next) | Priority: P2 | Complexity: M
...
- **Осталось:** шаг 5 — живой прогон в OBStests (Obsidian должен быть открыт). Ворота его не
  заменяют: `main.ts` в этом дереве юнит-тестами не покрывается вовсе.
