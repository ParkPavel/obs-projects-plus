...
- **Осталось открытым: только визуальный вес** — первичное действие блока весомее cog, фильтр вида
  поднимается в постоянно видимую полосу. Это **дизайнерское решение**, а не уборка: по маршрутизации
  оно идёт через `designer`, и придумывать его в обход правила я не стал.
