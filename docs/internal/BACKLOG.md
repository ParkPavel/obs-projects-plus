...
- **Одиннадцатый проход — P1: пустой файл считался разрешением эпизода.** Ветка «пусто» звала
  ...
  строке таблицы.
- **Ворота:** tsc 0, jest 231/3567, lint 0 ошибок / 110 предупреждений, svelte-check 0/0.
...
- **Ворота после каждого шага:** сейчас tsc 0, jest 233 суиты / 3591 тест, lint 0 ошибок / 110
