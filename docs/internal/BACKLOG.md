...
- Status: 📋 TODO — наблюдение 2026-09-05 (дважды за день) | Milestone: (next) | Priority: P2 | Complexity: S
- analysis_required: false
...
- Status: 📋 РЕШЕНО ПОЛЬЗОВАТЕЛЕМ 2026-09-06, ждёт спецификации | Milestone: (next) | Priority: P2 | Complexity: S
- analysis_required: false — нужен проход `designer`
...
- Status: 📋 РЕШЕНО ПОЛЬЗОВАТЕЛЕМ 2026-09-06, ждёт плана | Milestone: (next) | Priority: P2 | Complexity: M
