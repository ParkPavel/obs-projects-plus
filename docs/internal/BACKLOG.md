...
- Status: 📋 TODO — решение пользователя 2026-09-04 | Milestone: (next) | Priority: **P1** | Complexity: M
...
- **Работа:** одна строка в `openRecord.ts` (`PLAIN_MODE`), новый модификатор в `modeFromEvent`,
  пункт в меню строки (`tableRowOps.buildRowMenuEntries`), обновление `R0_17_recordOpenContract`.
