...
> Historical snapshot, retired 2026-09-10. The current harness uses native Obsidian CLI.
> Use the [current acceptance guide](../MANUAL_TESTING_PIPELINE.md) and [Claudex](https://github.com/ParkPavel/claudex).
...
| Что | Где |
|---|---|
| Vault | `../OBStests/` — сосед репозитория (индивидуальный абсолютный путь удалён из архивной публикации) |
