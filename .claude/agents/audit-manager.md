...
For any ticket modifying public-facing behavior (new widget type, new formula function, new field type, new setting): verify corresponding documentation was updated. If docs changed, flag for user review.
...
**READY FOR PR** means: all 4 gates green, all invariants pass, no P0/P1 findings.
...
- Writing or modifying documentation → flag gaps; `context-manager` or user writes.
