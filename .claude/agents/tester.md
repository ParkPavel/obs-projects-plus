---
name: tester
description: "Use when: writing Jest tests, running type checks, analyzing test coverage, verifying invariants via tests, deploying build to OBStests vault, ensuring the 134-suite / 2020-test baseline holds, producing untestable-features reports for UI-only changes."
---
...
- Verify test baseline: **134 suites / 2020 tests**.
...
- Baseline: **134 suites / 2020 tests PASS**.
...
npm test                    # gate 2: all suites (134 / 2020 baseline)
