...
## [Unreleased] — 3.5.1-alpha плюс 310 коммитов

> **О нумерации.** `3.5.1-alpha` проставлена 2026-05-14 (`9034cea`) и с тех пор не менялась, а
> поверх неё легло **310 коммитов**. Всё, что описано в этом разделе, физически находится в
> `main`, но ни одна выпущенная версия его не называет. Расхождение тегов, манифеста и
> репозитория разбирается в #175; здесь фиксируется содержание, а не номер.
>
